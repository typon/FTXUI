...
TEST(FlowHelperTest, BasicRow) {
  flow_helper::Block block_10_5;
  block_10_5.min_size_x = 10;
  block_10_5.min_size_y = 5;

  flow_helper::Global g;
  g.blocks = {
  ...
  g.size_x = 32;
  g.size_y = 16;
  g.config = FlowConfig().Set(FlowConfig::Direction::Row);
  flow_helper::Compute(g);
...
TEST(FlowHelperTest, BasicColumn) {
  flow_helper::Block block_10_5;
  block_10_5.min_size_x = 10;
  block_10_5.min_size_y = 5;
  ...
  g.size_x = 32;
  g.size_y = 16;
  g.config = FlowConfig().Set(FlowConfig::Direction::Column);
  flow_helper::Compute(g);
...
TEST(FlowHelperTest, BasicRowInversed) {
  flow_helper::Block block_10_5;
  block_10_5.min_size_x = 10;
  block_10_5.min_size_y = 5;
  ...
  g.size_x = 32;
  g.size_y = 16;
  g.config = FlowConfig().Set(FlowConfig::Direction::RowInversed);
  flow_helper::Compute(g);
...
TEST(FlowHelperTest, BasicColumnInversed) {
  flow_helper::Block block_10_5;
  block_10_5.min_size_x = 10;
  block_10_5.min_size_y = 5;
  ...
  g.size_x = 32;
  g.size_y = 16;
  g.config = FlowConfig().Set(FlowConfig::Direction::ColumnInversed);
  flow_helper::Compute(g);
